...
public class EtiquetaLaminaPedido implements ExecutableProgram {

	private static final String NOME_PROGRAMA = "etiqueta_lamina_pedido";
	...
	public void execute(String data, PrintService printService) {
		...
		String nrSerie = args[7];
		String dsProduto = args[8];
		String dsRebaixo = args[9];
		String dsDegrade = args[10];
		String dsOpcao = args[11];
