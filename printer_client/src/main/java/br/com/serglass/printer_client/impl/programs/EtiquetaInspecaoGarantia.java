...
public class EtiquetaInspecaoGarantia implements ExecutableProgram {

	private static final String NOME_PROGRAMA = "etiqueta_inspecao_garantia";
		...
		try (BufferedReader br = new BufferedReader(new FileReader(
			...
			while ((line = br.readLine()) != null) {
				...
				if (line.contains("vdata")) {
					line = line.replace("vdata", dtInspecao);
				}
